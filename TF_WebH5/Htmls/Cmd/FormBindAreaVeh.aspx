<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormBindAreaVeh.aspx.cs" Inherits="Htmls_Cmd_FormBindAreaVeh" %>
    ...
    <script type="text/javascript">
        ...
        function send()
        {
            try
            {
                ...
                var bCheckTime = false;// $('#chkTime')[0].checked;
...
//                }
                ...
                $.ajax({
                    ...
                    dataType:'json',
                    async:true, 
                    data:{username:sUserName,Pwd:sPwd,doType:'SaveAdministrativeAreasFenceVeh',loginDefaultType:1,cid:txtID,vehs: sVeh,InOrOut: sFenceType,IsTime:bCheckTime,StartTime: sStartTime, EndTime: sEndTime},
                    success:function(data){
                            if(data.result == "true")
                            {
                                ...
                                $.each(arrVeh,function(i,value){
                                    jsonPolygonInfo.lstVeh.push({"VehID":value,"InOrOut":sFenceType,"IsTime": bCheckTime,"StartTime":sStartTime,"EndTime":sEndTime});
                                });
                                window.parent.window.AreaSync();
