<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormYJRoad.aspx.cs" Inherits="Htmls_Cmd_YJ_FormYJRoad" %>
...
<body>
    <div style="float:left; height:100%" id="divList">
        <ul class="easyui-datalist" id="ulList" title="<% =Resources.Lan.VehList %>" lines="true" style="width:140px; height:518px">
		    <li value=""></li>
        </ul>
    </div>
