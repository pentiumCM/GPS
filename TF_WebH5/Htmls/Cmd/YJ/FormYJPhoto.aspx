<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormYJPhoto.aspx.cs" Inherits="Htmls_Cmd_YJ_FormYJPhoto" %>
...
<body>
    ...
    <div id="tt">
		...
		<a href="javascript:void(0)" class="icon-add" onclick="javascript:window.parent.window.TaskPic('#Y1602',4)"></a>
