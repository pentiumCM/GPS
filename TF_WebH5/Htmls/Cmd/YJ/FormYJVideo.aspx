<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormYJVideo.aspx.cs" Inherits="Htmls_Cmd_YJ_FormYJVideo" %>
...
//                                  //获取图片
//                                  iTry = iTry + 1;
//	                               var sTime = data.Entity.createDate;
//	                               if(sTime == sLastTime)
//	                               {
//	                                    if(iTry <= 1)
//	                                    {
...
<body onunload="UnLoad()">
    <div id="panelPic" class="easyui-panel" data-options="fit:true,iconCls:'icon-photo',tools:'#tt'" title="<% =Resources.Lan.RealtimeVideoMonitoring %>" style="width:100%; height:100%">
