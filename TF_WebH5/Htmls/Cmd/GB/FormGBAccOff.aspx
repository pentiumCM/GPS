<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormGBAccOff.aspx.cs" Inherits="Htmls_Cmd_GB_FormGBAccOff" %>
...
<body>
    ...
    <div style="float:left">
        <div class="easyui-panel" title="<% =Resources.Lan.RightAccOffTimingInterval %>" style="width:280px; height:300px">
		    <div>
	            <form id="ff" method="post">
	    		    ...
	    		    <tr>
	    			    ...
	    			    <td><input style="width:80px" class="easyui-textbox" type="text" id="txtInterval" value="60" name="txtInterval" />&nbsp;<% =Resources.Lan.Second %></td>
	    		    </tr>
	    		    <tr>
	    			    <td></td>
	    			    <td></td>
