<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormNotInPolygonQuery.aspx.cs" Inherits="MHtmls_Reports_FormNotInPolygonQuery" %>
        ...
        <div>
                <table cellpadding="5" width="100%">
	    		   <tr>
	    		        ...
	    		        <td>
	    		            <input style="width:120px" id="txtVeh" name = "txtVeh" type="text" value="" />
    	    	            <img alt="" title="" src="../../EasyUI/themes/icons/search.png" onclick="ShowDivVehTree();" /> 
	    		        </td>
	    		    </tr>	    		   <tr>	    		        <td width="80" style="text-align:right">
	    		            <% =Resources.Lan.StartTime%>：
	    		        </td>	    		        <td>	    		            <input id="txtBeginTime"  editable="false" class="easyui-datetimebox" style="width:158px;" name="txtBeginTime" data-options="formatter:formatter1,parser:parser1,showSeconds:true" value="2016-04-02 00:00:01" />	    		        </td>	    		   </tr>	    		   <tr>	    		    	    		        <td width="80" style="text-align:right">
	    		            <% =Resources.Lan.EndTime %>：
	    		        </td>	    		        <td>	    		            <input id="txtEndTime"  editable="false" class="easyui-datetimebox" style="width:158px;" name="txtEndTime" data-options="formatter:formatter1,parser:parser1,showSeconds:true" value="2016-04-02 23:59:59" />	    		        </td>	    		   </tr>	    		   <tr>	    		    <td colspan = "2">	    		        <a href="#;" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="Query();"><% =Resources.Lan.Query %></a>	    		    </td>	    		   </tr>	    	 </table>		                      
		</div>
    </div>
