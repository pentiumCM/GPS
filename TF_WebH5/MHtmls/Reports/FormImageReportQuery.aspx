<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormImageReportQuery.aspx.cs" Inherits="MHtmls_Reports_FormImageReportQuery" %>
...
<body >
        ...
        <div>
                <table cellpadding="5" width="100%">
	    		   <tr>
	    		        ...
	    		        <td>
	    		            <input id="txtVeh" style="width:130px;" name = "txtVeh" type="text" value="" />
    ...
    <div class="easyui-navpanel" id="divData" style="-webkit-overflow-scrolling: touch;">
        ...
        <table id="tableReport" class="easyui-datagrid" style="height:100%; width:100%; " data-options="idField:'imgID',singleSelect:true,collapsible:true">
		    <thead>
		        <tr>
		            <th data-options="field:'imgID',width:50,hidden:true,halign:'center'" >ID</th>
		            <th data-options="field:'name',width:80,align:'left',halign:'center' "><% =Resources.Lan.Plate %></th>
