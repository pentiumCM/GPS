<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormMileReportQuery.aspx.cs" Inherits="MHtmls_Reports_FormMileReportQuery" %>
        ...
        <div>
                <table>
				    ...
				    <tr>
                        ...
                        <td style="width:165px">
                            <input id="txtBeginTime"  editable="false" class="easyui-datetimebox" style="width:160px;" name="txtBeginTime" data-options="formatter:formatter1,parser:parser1,showSeconds:true" value="2016-04-02 00:00:01" />
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:right; width:110px;">
                        ...
                        <td style="width:165px">
                            <input id="txtEndTime" editable="false" class="easyui-datetimebox" style="width:160px;" name="txtEndTime" data-options="formatter:formatter1,parser:parser1,showSeconds:true" value="2016-04-02 23:59:59" />
                        </td>
                    </tr>
                    <tr>
                        <td  style="text-align:right; width:110px;">
                   ...
                   <tr>
                    ...
                    <tr>
                        <td  colspan="2" >
                            ...
                            <select class="easyui-combobox" disabled="disabled" name="txtMileCorType" id="txtMileCorType" style="width:80px">
		                        <option value="0"><% =Resources.Lan.Add %></option>
		                        <option value="1"><% =Resources.Lan.Reduce %></option>                            </select>
                            
                            <input class="easyui-numberbox" disabled="disabled" style="width:50px" precision="2" id="txtMileCorValue" value="1" data-options="min:0.00,max:100.00" />%
                        </td>                        
                    </tr>
                    <tr>
                        <td  style="text-align:right; width:110px;">
    ...
    <div class="easyui-navpanel" id="divData" style="-webkit-overflow-scrolling: touch;">
        <header>
            ...
            <table id="GridReport" class="easyui-datagrid" style="height:100%" data-options="idField:'id',singleSelect:true,collapsible:true">
		        <thead>
			        <tr>
			            <th data-options="field:'Cph',width:120,sortable:true,order:'desc',remoteSort:false"><% =Resources.Lan.Plate %></th>
                        ...
                        <th data-options="field:'Oil',width:80"><% =Resources.Lan.FuelConsumption %></th>
