<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormSchedulingCmdSetting.aspx.cs" Inherits="MHtmls_Cmd_K1_FormSchedulingCmdSetting" %>
    ...
    <script type="text/javascript">
        ...
        function send()
        {
            try
            {
                ...
                window.parent.window.SendCmdText("SendSchedulingInformation",sCode + "," + sText, 5, "<% =Resources.Lan.SendSchedulingInformation %>", "<% =Resources.Lan.SendSchedulingInformation %>")
                closeForm();
            }
            catch(e)
            {
