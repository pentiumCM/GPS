<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormYJVideoCmd.aspx.cs" Inherits="MHtmls_Cmd_YJ_FormYJVideoCmd" %>
    ...
    <script type="text/javascript">
        ...
        function send()
        {
            try
            {
                ...
                window.parent.window.SendCmdYJVideo("YJVideo", iChannel, iResolution, sUpload, iShootingInterval, iImageQuality, 4, "<% =Resources.Lan.RealtimeVideoMonitoring %>", "<% =Resources.Lan.RealtimeVideoMonitoring %>")
                closeForm();
            }
            catch(e)
            {
...
<body>
    <div class="easyui-navpanel" style="-webkit-overflow-scrolling: touch;">
        ...
        <div style="float:left">
            <div class="easyui-panel" title="<% =Resources.Lan.RealtimeVideoMonitoring %>" style="width:320px; height:300px">
		    <div>
	            <form id="ff" method="post">
	    		    ...
	    		    <tr>
	    			    ...
	    			    <td>
	    			        <input class="easyui-numberbox" data-options="min:0,max:65535,required:true" id="txtShootingInterval" value="5" disabled="disabled" style="width:130px" />&nbsp;(<% =Resources.Lan.Second%>)
	    			    </td>
	    		    </tr>
	    		    <tr>
	    		    ...
	    		    <tr>
	    			    ...
	    			    <td >
	    			        <input type="radio" name="txtUpload" value="0" checked="checked" /><% =Resources.Lan.DoNotUpload %> 
                            <input type="radio" name="txtUpload" value="1" /><% =Resources.Lan.RealtimeUpload %> 
	    			   </td>
	    		    </tr>
	    	    </table>
	            </form>
