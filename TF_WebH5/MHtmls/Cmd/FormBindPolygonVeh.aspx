<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormBindPolygonVeh.aspx.cs" Inherits="MHtmls_Cmd_FormBindPolygonVeh" %>
        ...
        function send()
        {
            try
            {
                ...
                $.ajax({
                    ...
                    dataType:'json',
                    async:true, 
                    data:{username:sUserName,Pwd:sPwd,doType:'SavePolygonVeh',loginDefaultType:1,cid:txtID,vehs: sVeh,InOrOut: sFenceType,IsTime:bCheckTime,StartTime: sStartTime, EndTime: sEndTime},
