<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormHistoryGoogleQuery.aspx.cs" Inherits="MHtmls_FormHistoryGoogleQuery" %>
...
//        $("#map").height(document.body.clientHeight);
   ...
   function setIconDirect()
   {
    ...
    function DrawLine()
    {
        ...
        polyLineNowAll = new google.maps.Polyline({ path: points, strokeColor: "#050BFF", strokeWeight: 3, strokeOpacity: 0.5 });
    ...
    function  setMapTrack(mapPointNow)
    {
        return;
             ...
             if(pointsTrack.length > 1)
             {
                ...
                polyLineNowTrack = newgoogle.maps.Polyline(line, { strokeColor: "#050BFF", strokeWeight: 5, strokeOpacity: 0.5 });
    ...
    <div class="easyui-navpanel" id="divMain" style="-webkit-overflow-scrolling: touch;">
        ...
        <div>            <table cellpadding="5" width="100%">
	    		   <tr>
	    		        ...
	    		        </td>	    		        <td>	    		            <input id="txtBeginTime" class="easyui-datetimebox" style="width:160px;" name="txtBeginTime" data-options="formatter:formatter1,parser:parser1,showSeconds:true" value="2016-04-02 00:00:01" />	    		        </td>	    		   </tr>	    		   <tr>	    		    	    		        <td width="80" style="text-align:right">
	    		            <% =Resources.Lan.EndTime %>：
	    		        </td>	    		        <td>	    		            <input id="txtEndTime" class="easyui-datetimebox" style="width:160px;" name="txtEndTime" data-options="formatter:formatter1,parser:parser1,showSeconds:true" value="2016-04-02 23:59:59" />	    		        </td>	    		   </tr>	    		   <tr>	    		    <td colspan = "2">	    		        <a href="#;" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="Query();"><% =Resources.Lan.Query %></a>		        	    		    </td>	    		   </tr>	    	 </table>				
		</div>
    </div>
