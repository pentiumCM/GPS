...
<body onkeydown="keyLogin();">
    ...
    <a id="btn-VehMsg" href="mng/Login.aspx" target="_blank" class="easyui-linkbutton" data-options="iconCls:'icon-setting'"><% =Resources.Lan.BackEnd %></a>
...
<div id="contPar" class="contPar">
	<div id="page1"  style="z-index:1;">
		<div class="title0"><% =Resources.Lan.Title %></div>
		<div class="title1"><% =Resources.Lan.TitleDetail %></div><!--旅游、交通、气象、公共安全、大数据-->
